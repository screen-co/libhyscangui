 ...
 * @Short_description: Меню слоёв и настроек
 * @Title: HyScanGtkLayerList
 *
 * Виджет #HyScanGtkLayerList представляет из себя меню доступных слоёв и
 * виджетов настроек.
 *
 ...
 *
 * Если для пункта меню установлен виджет настройки, то он раскрывает при выборе
 * этого пункта.
 */
